...
while play_blackjack ==True:
    ...
    if user_score==21:
        user_score = 0
        print(f"Your score is {user_score}, you win by blackjack")
        ...
        extra_card = True
        while extra_card == True: #while loop to allow user to keep darwing card until he want to stop
        ...
        #chekcing for score greater then 21 with Ace
        if user_score > 21:
        ...
        #checking(compare) for final result of game
